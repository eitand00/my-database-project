...
DROP VIEW IF EXISTS vw_dashboard_counts, vw_teams_list, vw_team_detail, vw_team_players,
    ...
    vw_teams_short, vw_stadiums_short, vw_referees_short, vw_tournaments,
    vw_high_scoring_matches, vw_big_stadiums_red_cards, vw_team_goals_analysis CASCADE;

-- ========== VIEWS ==========
\i views/vw_dashboard_counts.sql
\i views/vw_teams_list.sql
\i views/vw_team_detail.sql
...
\i views/vw_teams_short.sql
\i views/vw_stadiums_short.sql
\i views/vw_referees_short.sql
\i views/vw_tournaments.sql
