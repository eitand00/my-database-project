...
DROP VIEW IF EXISTS vw_dashboard_counts, vw_teams_list, vw_team_players, vw_team_matches,
    vw_teams_short, vw_players_list, vw_player_detail, vw_player_events,
    vw_player_match_stats, vw_matches_list, vw_match_detail, vw_match_events,
    vw_match_player_stats, vw_stadiums_list, vw_stadiums_short, vw_referees_list,
    vw_referees_short, vw_events_list, vw_high_scoring_matches,
    vw_big_stadiums_red_cards, vw_team_goals_analysis, vw_team_detail,
    vw_tournaments CASCADE;
